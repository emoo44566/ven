...
def calculate_single_phase_line_inductance(mu, D, r):
   """
   Calculate the inductance of a single-phase transmission line.
   ...
   Returns:
   - inductance: Inductance of the single-phase transmission line (Henry)
   """
...
# محاسبه اندوکتانس خطوط یکفاز
inductance_value = calculate_single_phase_line_inductance(
   magnetic_permeability, distance_between_conductors, radius_of_conductor
)

# نمایش نتیجه
print(f"The inductance of the single-phase transmission line is {inductance_value:.6f} Henry.")